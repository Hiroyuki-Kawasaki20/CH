...
class TestRegression20260805:
    ...
    def test_previous_end_time_floor_is_respected(self):
        ...
        ※ Issue #83 修正で前回終了時刻が探索フェーズにも正しく反映されるようになった。
           本フィクスチャは床23:09を守ると短休憩(23:10-23:30)をまたぐため実際の開始は
           23:31・終了23:36となり、締切23:25(入車23:35-10分)に対し11分の締切超過が
           生じる(2026-09-24 C-6でPICKUP_DEADLINE_BUFFER_SECS 20分→10分・短休憩
           30分→20分に短縮した影響。旧アサーションの「メイン配置」は探索が床を
        ...
        mountains = [(1, "01", 60, 1)]
        arrivals = {"01": "23:35"}  # 締切23:25(23:35-10分)。床23:09→実開始23:31・終了23:36で11分超過(C-6)
